<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="伦理编号" prop="sampleNumber">
        <el-input
    ...
    <el-table v-loading="loading" :data="sampleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="伦理编号" align="center" prop="sampleId" />
      <el-table-column label="伦理编号" align="center" prop="sampleNumber" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="伦理编号" prop="sampleNumber">
          <el-input v-model="form.sampleNumber" placeholder="请输入伦理编号" />
        </el-form-item>
      </el-form>
...
<script>
import { listSample, getSample, delSample, addSample, updateSample, exportSample } from "@/api/system/sample";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除人类样本编号为"' + sampleIds + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有人类样本数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
