<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="itemList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="培训发布人" align="center" prop="trainAdder" />
      <el-table-column label="培训时间" align="center" prop="trainTime" >
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.trainTime, '{y}-{m}-{d} {h}:{i}:{s}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="培训地点" align="center" prop="trainAd" />
      <el-table-column label="培训备注" align="center" prop="trainTip" />
      <el-table-column label="培训最大人数" align="center" prop="trainMaxPerson" />
    ...
    <el-dialog :title="title" :visible.sync="open2" width="500px" append-to-body>
      <el-table v-loading="loading" :data="trainAndUser">
        <el-table-column type="selection" width="55" align="center" />
