...
<script>
import { listlabSubscribe, getSubscribe, delSubscribe, addSubscribe, updateSubscribe, exportSubscribe } from "@/api/lab/subscribe";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listlabSubscribe(this.queryParams).then(response => {
